...
const Navbar = () => {
  ...
  return (
    <header
      className={`lg:px-2 py-3 fixed left-0 right-0 z-10 trasnition duration-200 ${
        isScrolled ? "bg-morph" : "bg-transparent"
      }`}
    >
...
const XlNavLink = ({ id, text }) => {
  return (
    <Link
      href={"#" + id}
      className="dark:text-stone-400 text-stone-600 font-medium dark:hover:bg-stone-800 hover:bg-stone-200 dark:hover:text-stone-200 hover:text-stone-800 rounded-md px-3 py-1"
    >
      {text}
    </Link>
  );
